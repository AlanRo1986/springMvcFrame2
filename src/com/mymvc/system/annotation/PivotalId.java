...
import com.mymvc.system.validation.PivotalIdValidation;
 ...
 */
@Constraint(
        validatedBy = {PivotalIdValidation.class}
)
@Documented
@Target({ElementType.ANNOTATION_TYPE,ElementType.METHOD, ElementType.FIELD})
@Retention(RetentionPolicy.RUNTIME)
public @interface PivotalId {
     ...
     * @return
     */
    String message() default "error_validate_pivotal_id";
