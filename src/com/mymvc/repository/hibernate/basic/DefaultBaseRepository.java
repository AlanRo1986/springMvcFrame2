 ...
 */
public abstract class DefaultBaseRepository<E extends Serializable> implements IDefaultRepository<E> {

    protected  final Class<E> entityClass;

    public DefaultBaseRepository(){
        ...
        while (!(genericSuperclass instanceof ParameterizedType)){
            ...
            if (genericSuperclass == DefaultBaseRepository.class){
